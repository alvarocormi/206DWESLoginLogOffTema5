...
//define("DSN", 'mysql:host=192.168.0.206;dbname=DB206DWESLoginLogOff');
...
define("DSN", 'mysql:host=192.168.20.19;dbname=DB206DWESLoginLogOff');
// // Usuario con el que se conecta 
define("USER", 'user206DWESLoginLogOff');
// // Contraseña con la que conectarse a la base de datos 
define("PASSWORD", 'P@ssw0rd');
// //MySQLi
define("HOST", '192.168.20.19');
define("DBNAME", 'DB206DWESLoginLogOff');
